...
def training_code():
    ...
    train_loader = DataLoader(train_set, batch_size=32, shuffle=True, num_workers=4, pin_memory=True, prefetch_factor=4)
    val_loader = DataLoader(val_set, batch_size=32, shuffle=False, num_workers=4, pin_memory=True, prefetch_factor=4)
    test_loader = DataLoader(test_set, batch_size=32, shuffle=False, num_workers=4, pin_memory=True, prefetch_factor=4)
...
# Define dataset class for inference on image folder
...
model = CustomModel().to(device)
model_path = "model_0.001_data_aug_sgd.pth"
